    ...
    <>
      <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl wrapper">
          ...
          />
          <div className="flex flex-col w-fll gap-8 p-5 md:p-10">
            <div className="flex flex-col gap-6">
              <h2 className="h2-bold">{event.title}</h2>
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex gap-3">
                  <p className="p-bold-20 rounded-full bg-green-500/10 px-5 py-2 text-green-500">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="p-medium-16 lg:p-medium-18 truncate text-primary-500 underline">
                {event.url}
              </p>
            </div>
          </div>
